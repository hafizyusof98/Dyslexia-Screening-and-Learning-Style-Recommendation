    ...
    <table id="example" class="display" style="width:100%">
        ...
        <c:forEach items="${testB }" var="testB">
            <tr>
                ...
                <td><a href="testController?action=takeISDTest&studentID=${testB.studentID }&studentName=${testB.studentName}"><i class="fa fa-pencil fa-fw"></i></a></td>
            </tr>
        </c:forEach>
            </tbody>
            </table>
